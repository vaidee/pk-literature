...
// terraform/modules/api-gateway) invokes this. Not wired into Terraform
// yet (no `module "lambda_api_catalog"` block exists — that's added
// when this service's Terraform lands, per terraform-layout.md's
// per-phase module ownership).
//
